...
namespace AkaShop.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            // any guid
            var roleId = new Guid("BAFD3E3D-DFD1-44AD-A676-D1343F6E12CD");
            var adminId = new Guid("492BF905-00FA-4B70-BB97-63553B33F9FB");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "Asdf1234!"),
                SecurityStamp = string.Empty,
                FirsName = "Nam",
                LastName = "Tran",
                Dob = new DateTime(1997,05,26)
            });
